...
- [mock-contract-parity](../../control-center/docs/delivery/initiatives/mock-contract-parity.md) — `proposed`.
  ...
  SDK item 4 implemented on branch `feat/conformance-range-order-limit` (not merged): the
  three case groups are in `runHistoricalConformance`, red against the unfixed mock, with
